...
class MemoCategory(AkNotebookCommonModel):
    ...
    memo_category_id = models.UUIDField(
        verbose_name='メモカテゴリID',
        default=uuid.uuid4, 
        primary_key=True, 
        editable=False
        )
    ...
    note = models.ForeignKey(
        ...
        verbose_name='ノートID',
        on_delete=models.CASCADE,
        related_name='Note_MemoCategory'
        )
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, 
        verbose_name='ユーザーID',
        on_delete=models.CASCADE,
        related_name='User_MemoCategory'
        )
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['parent_memo_category', 'memo_category_name'], name='ParentMemoCategory_MemoCategoryName_Unique')
        ]
...
class Purpose(AkNotebookCommonModel):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['note', 'purpose_name'], name='Note_PurposeName_Unique')
        ]
...
class Memo(AkNotebookCommonModel):
    ...
    note = models.ForeignKey(
        ...
        verbose_name='ノートID',
        on_delete=models.CASCADE,
        related_name='Note_Memo'
        )
    parent_memo_category = models.ForeignKey(
        MemoCategory,
        verbose_name='親メモカテゴリID',
        on_delete=models.CASCADE,
        related_name='ParentMemoCategory_Memo'
        )
    child_memo_category = models.ForeignKey(
        MemoCategory,
        verbose_name='子メモカテゴリID',
        on_delete=models.CASCADE,
        related_name='ChildMemoCategory_Memo'
        )
    purpose = models.ForeignKey(
        ...
        null=True,
        on_delete=models.CASCADE,
        related_name='Purpose_Memo'
        )
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, 
        verbose_name='ユーザーID',
        on_delete=models.CASCADE,
        related_name='User_Memo'
        )
...
class StickyNoteCategory(AkNotebookCommonModel):
    ...
    sticky_note_category_code = models.CharField(
        verbose_name='付箋カテゴリコード',
        max_length=4,
        primary_key=True 
        )
    sticky_note_category_name = models.CharField(
        verbose_name='付箋カテゴリ名',
        help_text='input:インプット用の付箋 output:アウトプット用の付箋',
        max_length=30,
        unique=True
        )
...
class StickyNote(AkNotebookCommonModel):
    ...
    sticky_note_id = models.UUIDField(
        verbose_name='付箋ID',
        default=uuid.uuid4, 
        primary_key=True, 
        editable=False
        )
    sticky_note_text = models.TextField(
        verbose_name='付箋'
        )
...
class BrowsingMemoCount(AkNotebookCommonModel):
    browsing_memo_count = models.IntegerField(
        verbose_name='メモ閲覧回数',
        help_text='メモを閲覧時に一行追加されることで閲覧とみなす',
        default=1,
        editable=False
        )
    memo = models.ForeignKey(
        ...
        verbose_name='メモID',
        on_delete=models.CASCADE,
        related_name='Memo_MemoBrowsingCount'
        )
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, 
        verbose_name='ユーザーID',
...
class DmBrowsingMemoCount(AkNotebookCommonModel):
    ...
    note = models.ForeignKey(
        ...
        verbose_name='ノートID',
        on_delete=models.CASCADE,
        related_name='Note_DmBrowsingCount'
        )
    parent_memo_category = models.ForeignKey(
        MemoCategory,
        verbose_name='親メモカテゴリID',
    ...
    purpose = models.ForeignKey(
        ...
        null=True,
        on_delete=models.CASCADE,
        related_name='Purpose_DmBrowsingCount'
        )
    memo = models.OneToOneField(
        Memo,
        verbose_name='メモID',
        on_delete=models.CASCADE,
        related_name='Memo_DmBrowsingCount'
        )
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, 
        verbose_name='ユーザーID',
        on_delete=models.CASCADE,
        related_name='User_DmBrowsingCount'
        )
...
class DmLearningEfficiency(AkNotebookCommonModel):
    ...
    note = models.ForeignKey(
        ...
        verbose_name='ノートID',
        on_delete=models.CASCADE,
        related_name='Note_DmLearningEfficiency'
        )
    parent_memo_category = models.ForeignKey(
        MemoCategory,
        verbose_name='親メモカテゴリID',
    ...
    purpose = models.ForeignKey(
        ...
        null=True,
        on_delete=models.CASCADE,
        related_name='Purpose_DmLearningEfficiency'
        )
    memo = models.ForeignKey(
        Memo,
        verbose_name='メモID',
        on_delete=models.CASCADE,
        related_name='Memo_DmLearningEfficiency'
        )
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, 
        verbose_name='ユーザーID',
