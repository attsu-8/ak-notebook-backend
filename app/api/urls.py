...
urlpatterns = [
    ...
    path('filter/parent-memo-category/', views.ParentMemoCategoryFilterListView.as_view(), name='parent-memo-category-filter'),
    path('filter/child-memo-category/', views.ChildMemoCategoryFilterListView.as_view(), name='child-memo-category-filter'),
    ...
    path('dm/three-month-ago-avg-learning-efficiency-rate/', views.ThreeMonthAverageLearningEfficiencyListView.as_view(), name='dm-three-month-ago-avg'),
    path('dm/each-note-learning-efficiency-rate/', views.EachNoteLearningEfficiencyListView.as_view(), name='dm-each-note'),
