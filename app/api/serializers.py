...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ("user_id", "user_email", "password")
...
class ProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Profile
        fields = ("profile_id", "profile_nickname", "profile_image", "user", "created_at", "updated_at")
...
class NoteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Note
        fields = ("note_id", "note_name", "note_color", "user", "is_active", "created_at", "updated_at")
        extra_kwargs = {"user": {"read_only": True}}
...
class ParentMemoCategorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        extra_kwargs = {"user": {"read_only": True}, "parent_memo_category": {"read_only": True}}
...
class StickyNoteCategorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ("sticky_note_category_code", "sticky_note_category_name", "created_at", "updated_at")
        extra_kwargs = {"user": {"read_only": True}}
...
class StickyNoteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = StickyNote
        fields = ("sticky_note_id", "sticky_note_text", "sticky_note_category", "user", "created_at", "updated_at")
        extra_kwargs = {"user": {"read_only": True}}
...
class BrowsingMemoCountSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ("browsing_memo_count", "memo", "user", "created_at", "updated_at")
        extra_kwargs = {"user": {"read_only": True}}
